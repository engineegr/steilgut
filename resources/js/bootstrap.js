...
try {
    ...
    if (!DEVICE_STATUS) {
        console.warn("bootstrap.js: couldn't find DEVICE_STATE store");
    } else {
        DEVICE_STATUS['BODY_SCROLL_LOCK'] = require('body-scroll-lock');
        DEVICE_STATUS['PLATFORM_TOOL'] = require('platform');
    }
} catch (e) { }
