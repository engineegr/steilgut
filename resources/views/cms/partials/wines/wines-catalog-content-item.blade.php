<div class="container-fluid wines-item-content">
    ...
    <div class="row wines-item-content-row">
        ...
        <div class="col-12 col-md-3 col-lg-4">
            <div class="row">
                <div class="col-12">
                    <h2 class="harvest-text tw-mr-10 tw-mb-8">{{ $item->harvest }}</h2>
                </div>
                <div class="col-12">
                    ...
                    @if ($isReadOnly)
                        ...
                        @else
                            <input id="type-input-id" name="wineType" type="text"
                                class="form-control wine-item-type-input" value="{{ $item->wineType }}" autofocus>
                    @endif

                    <h1 class="wine-item-title-text">{{ $item->title }}</h1>
                    <input name="title" type="hidden" class="form-control wine-item-title-input" value="{{ $item->title }}">
                </div>
