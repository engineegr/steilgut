...
@section('content')
    <div class="item-form">
        ...
        <form action="{{ route('admin.dashboard.wines-catalog.update', $item->id) }}" method="POST"
            enctype="multipart/form-data" class="wines-catalog-form">
            @csrf
            @include('cms.partials.wines.wines-catalog-content-item')
                    ...
                    <div class="item-form-control tw-my-3 tw-max-w-full tw-w-full">
                        ...
                        <div
                            ...
                            <a class="tw-w-full tw-my-auto tw-text-gray-600 tw-font-semibold tw-no-underline hover:tw-no-underline hover:tw-text-white tw-py-2"
                                href="{{ route('admin.dashboard.wines-catalog') }}">Back</a>
                        </div>
                    </div>
                </div>
            </div>
